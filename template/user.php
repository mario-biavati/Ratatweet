...
if (count($userData) == 1) :
    ...
    <article id=<?php echo "user{$userData["IDuser"]}"; ?>>
            ...
            <?php $idLogged = $_SESSION["idUser"];
                ...
                <div style="margin-right: 1em">
                    <button type="button" class="btn btn-info text-white" alt="<?php echo $FollowStatus; ?> user" id="followbutton" onclick="<?php echo strtolower($FollowStatus)."()"?>" style="height:30px; width: auto; padding: auto; line-height: 10px;">
                ...
                <div style="margin-left: 1em">
                    <button type="button" class="btn btn-outline-secondary" alt="<?php echo $notif; ?> notifications" id="notificationbutton" onclick="<?php echo ($notif == "Enable") ? "enableNotifications()" : "disableNotifications()"; ?>" <?php if ($FollowStatus == "Follow") echo "disabled"; ?> style="height:30px; width: auto; padding: auto; line-height: 10px;">
