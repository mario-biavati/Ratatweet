        ...
        <?php foreach($recipes as $recipe): ?>
            ...
            <li id=<?php echo "Post{$recipe["IDpost"]}"; ?> class="list-group-item border rounded w-100 mx-auto mt-2">
                ...
                <div class="my-2 p-2 border-top collapse" id="more<?php echo "{$recipe["IDpost"]}"; ?>">
                    ...
                    <button type="button" alt="Use recipe" class="btn btn-info text-white" id="UseRecipe-button<?php echo $recipe['IDpost']; ?>" onclick="useRecipe(<?php echo $recipe['IDrecipe']; ?>)">Use</button>
                    <?php if($n == 0): ?><button type="button" alt="Delete recipe" class="ms-3 btn btn-danger text-white" id="DeleteRecipe-button<?php echo $recipe['IDpost']; ?>" onclick="deleteRecipe(<?php echo $recipe['IDpost']; ?>)">Delete</button><?php endif; ?>
                </div>
